...
export default function Examplescomp() {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen  p-4 md:p-8 lg:p-12">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-center">Very Simple Facebook/ChatGpt Agent</h1>
        <div className="w-full max-w-md md:max-w-lg lg:max-w-2xl">
          <video
            controls
            className="w-full rounded-lg shadow-lg"
          >
            <source src="/static/images/fb-agent-vid.mp4" type="video/mp4" />
